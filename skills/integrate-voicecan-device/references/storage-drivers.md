...
- `server_relay`: planned fallback. Requires reviewed protocol-runtime integration, device-level serialization, offsets, backpressure, and persistent transfer state.
