...
This preview supports the local filesystem upload path and simulator end to end. The compiled protocol runtime, Browser/Node WASM loaders, WebBluetooth transport, and Gateway Actor are included and conformance-gated. Treat physical V1.2 results, S3 direct integration, full relay orchestration, private CA/IP, SEA, and multi-instance PostgreSQL as blocked until their named validation artifacts are present.
